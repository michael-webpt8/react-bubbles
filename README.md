...
- a token is used for user authentication. keeps track of users like a cookie would. for authorized routes.

- [ ] What steps can you take in your web apps to keep your data secure?

- use tokens instead of cookies and authorized routes when needed

- [ ] Describe how web servers work.

- process incoming network requests over
